...
def main(rollout_index):
    ...
    trainingFolder = f"./trainingData/test/iter_{Iterations}_epochs_{Epochs}_episodes_{Episodes}_horizon_{Horizon}/"
    ...
    with open(trainingFolder + f"test_sample_{rollout_index}.pkl", 'wb') as f:
