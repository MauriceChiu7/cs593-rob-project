...
def main(path_index):
    ...
    with open(trainingFolder + f"ur5sample_{path_index}.pkl", 'wb') as f:
        pickle.dump(saveRun, f)

    with open(errorFolder + f"debug_{path_index}.pkl", 'wb') as f:
        pickle.dump(debug, f)

    with open(errorFolder + f"finalEePos_{path_index}.pkl", 'wb') as f:
